...
public class Lighting {
	...
	/*
	 * Computes the illuminated color of a 3D points of given position, normal
	 * and color, and given the camera position and material parameters. Returns
	 * an array of size 3.
	 */
	public double[] applyLights(Vector3 position, Vector3 normal, double[] color, Vector3 cameraPosition, double ka,
		...
		while (it.hasNext()) {
			...
			case POINT:
				try {
					...
					double Is = light.params[3] * ks ; //PAS FINIIII
					I += Id + Is;
